...
const Header = () => {
  ...
  return (
    <header className="flex justify-between items-center gap-4 px-4 h-14">
      {/* Sol Logo */}
      <div className="flex items-center gap-3">
        <button
          onClick={toggleSidebar}
          className="p-2 hover:bg-[#3f3f3f] rounded-full transition duration-200"
        >
        ...
        >
          <div className="flex flex-1">
            <input
              type="text"
              defaultValue={query}
              className="w-full h-10 px-4 bg-[#121212] border border-[#3f3f3f] rounded-l-full text-white placeholder:text-[#aaaaaa] focus:border-[#1c62b9] outline-none"
              placeholder="Ara"
            />
